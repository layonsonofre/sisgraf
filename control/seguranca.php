...
function validaUsuario($usuario, $senha) {
  ...
  $sql = "SELECT `idPessoa`, `usuario` FROM `".$_SG['tabela']."` WHERE ".$cS." `usuario` = '".$nusuario."' AND ".$cS." `senha` = '".$nsenha."' LIMIT 1";
  ...
  if (empty($resultado)) {
    ...
    $_SESSION['usuarioID'] = $resultado['idPessoa']; // Pega o valor da coluna 'id do registro encontrado no MySQL
